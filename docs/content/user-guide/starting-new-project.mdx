...
**Ark provides the runtime, not where you build agents.** This guide shows you how to create a new agent project in its own repository, separate from the Ark repository.

- **Ark Repository**: Contains the runtime code (controllers, APIs, services)
